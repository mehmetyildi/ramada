...
namespace App\Http\Controllers\Cms\Campaigns;

use Illuminate\Http\Request;

use App\Http\Controllers\Cms\BaseController;
use App\Models\Campaign as PageModel;
...
class CampaignsController extends BaseController
{
    ...
    public function __construct(PageModel $model)
    {
        ...
        $this->pageUrl = 'campaigns';
        $this->pageName = 'Kampanya Duyurular';
        $this->pageItem = 'Kampanya Duyuru';
    ...
    public function store(Request $request)
    {
        ...
        if($this->imageFields){
            foreach($this->imageFields as $imageField){
                parent::handleImageCropUploadNoResize(
                    $record,
                    $imageField['naming'],
                    $imageField['diff'],
