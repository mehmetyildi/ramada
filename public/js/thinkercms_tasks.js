$(document).ready(function(){
    $("#todo, #completed").sortable({
        ...
        update: function( event, ui ) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: globalBaseUrl + '/thinkercms/tasks/order',
            ...
            $.ajax({
                ...
                type: 'POST',
                url: globalBaseUrl + '/thinkercms/tasks/orderCompleted',
                success: function(response) {
                    //
                },
            });
    ...
    $(document).delegate('#addTaskForm', 'submit', function(e){
        ...
        request = $.ajax({
            data: serializedData,
            type: 'POST',
            url: globalBaseUrl + '/thinkercms/tasks',
            success: function (response) {
    ...
    $(document).delegate('.updateTaskForm', 'submit', function(e){
        ...
        request = $.ajax({
            data: serializedData,
            type: 'POST',
            url: globalBaseUrl + '/thinkercms/tasks/update',
            success: function (response) {
                $("#currentTaskList").load(location.href + " #currentTaskList");
                toastr.success(response);
            },
