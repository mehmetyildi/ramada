    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="{{ (strpos($currentRouteName, 'popups') !== false) ? 'active' : '' }}">
                <a href="{{ route('cms.popups.index') }}"><i class="fa fa-globe"></i> <span class="nav-label">Popuplar </span></a>
            </li>
            @endcan

            @can('edit_content')
            <li class="{{ (strpos($currentRouteName, 'campaigns') !== false) ? 'active' : '' }}">
                <a href="{{ route('cms.campaigns.index') }}"><i class="fa fa-globe"></i> <span class="nav-label">Kampanyalar </span></a>
            </li>
            @endcan
