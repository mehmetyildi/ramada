		...
		<div class="col-md-12 ">
			<div class="pageWithSideBar row clearfix">
				<div class="col-md-4 col-xs-12">
					...
					<br>
					<a href="" class="sidebarLink selected">{{ trans('local.rooms.executive.title') }}</a>
				</div>
				<div class="col-md-8 col-xs-12">
					<h1>{{ trans('local.rooms.executive.title') }}</h1>
					<div id="ramadaCarousel" class="carousel slide relative" data-ride="carousel">
					  	...
					  	<div class="carousel-inner">
					    	<div class="carousel-item active">
					      		<img class="d-block w-100 fullWidth" src="{{ asset('/img/rooms/executive/1.jpg') }}" alt="{{ trans('local.rooms.executive.title') }}" title="{{ trans('local.rooms.executive.title') }}">
					    	</div>
					    	<div class="carousel-item">
					      		<img class="d-block w-100 fullWidth" src="{{ asset('/img/rooms/executive/2.jpg') }}" alt="{{ trans('local.rooms.executive.title') }}" title="{{ trans('local.rooms.executive.title') }}">
					    	</div>
					    	<div class="carousel-item">
					      		<img class="d-block w-100 fullWidth" src="{{ asset('/img/rooms/executive/3.jpg') }}" alt="{{ trans('local.rooms.executive.title') }}" title="{{ trans('local.rooms.executive.title') }}">
					    	</div>
					...
					<div class="row roomInfoRow">
						<div class="col-md-12">
							<p>{!! trans('local.rooms.executive.description') !!}</p>
						</div>
