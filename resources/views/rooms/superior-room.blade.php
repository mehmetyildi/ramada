		...
		<div class="col-md-12 ">
			<div class="pageWithSideBar row clearfix">
				<div class="col-md-4 col-xs-12">
					...
					<br>
					<a href="" class="sidebarLink selected">{{ trans('local.rooms.superior.title') }}</a>
					<br>
				...
				<div class="col-md-8 col-xs-12">
					<h1>{{ trans('local.rooms.superior.title') }}</h1>
					<div id="ramadaCarousel" class="carousel slide relative" data-ride="carousel">
					  	...
					  	<div class="carousel-inner">
					    	<div class="carousel-item active">
					      		<img class="d-block w-100 fullWidth" src="{{ asset('/img/rooms/superior/1.jpg') }}" alt="{{ trans('local.rooms.superior.title') }}" title="{{ trans('local.rooms.superior.title') }}">
					    	</div>
					    	<div class="carousel-item">
					      		<img class="d-block w-100 fullWidth" src="{{ asset('/img/rooms/superior/2.jpg') }}" alt="{{ trans('local.rooms.superior.title') }}" title="{{ trans('local.rooms.superior.title') }}">
					    	</div>
					    	<div class="carousel-item">
					      		<img class="d-block w-100 fullWidth" src="{{ asset('/img/rooms/superior/3.jpg') }}" alt="{{ trans('local.rooms.superior.title') }}" title="{{ trans('local.rooms.superior.title') }}">
					    	</div>
					...
					<div class="row roomInfoRow">
						<div class="col-md-12">
							<p>Sizler için özel tasarlanmış, modern mimarisi ve eşsiz konforu ile <br> oldukça ferah, ışık alan 60 metrekare büyüklükte <br>  1 oturma odası ve özel dizayn edilmiş yatak odası...</p>
						</div>
